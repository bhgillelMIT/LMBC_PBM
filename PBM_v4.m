function results = PBM_v4(inputs)
...
%% Model Inputs
    ...
    %[y0, params] = InitializeVolumes(params, mesh, disc);
        ...
        if strcmp(params.chars.type, 'LC')
            ...
            if params.chars.load
                try
                    ...
                    warning(sprintf('---- File (%s) not found, calculating characteristics instead.\n', filename));
